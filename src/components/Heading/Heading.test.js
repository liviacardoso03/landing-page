...
describe('<Heading />', () => {
  it('should render with default values', () => {
    //'deve renderizar com os valores padrões'
  ...
  it('should render with white color', () => {
    //'deve renderizar com a cor branca'
  ...
  it('should render correct heading sizes', () => {
    //'deve renderizar coretamente os tamanhos do cabeçalho'
  ...
  it('should render correct font-size when using mobile', () => {
    //'deve renderizar corretamente o tamanho da fonte quando estiver usando mobile'

    const { rerender } = renderTheme(<Heading size="huge">texto</Heading>);
    const heading = screen.getByRole('heading', { name: 'texto' });

    expect(screen.getByRole('heading', { name: 'texto' })).toHaveStyleRule(
      //'espero que a fonte seja desse tamanho, quando a tela for menor do que medium'
      'font-size',
  ...
  it('should render with uppercase letters', () => {
    //'deve renderizar com as letras maiúsculas'
  ...
  it('should render correct heading element', () => {
    //'deve renderizar corretamente os elementos do heading'
